({
    ...
    populateAllValues : function(component, event, helper,isFromInit){
        ...
        component.set('v.urlParamMap', vars);
            component.set('v.simpleNewFormSubmission.GCLID__c', vars['gclid']);
	...
	getformHeadline : function(component, event, helper) {
        var copyHead = component.get('v.formTitle');
        let expert = false;
        ...
        document.getElementById('formhead').innerHTML = parserHead;        
	}
